...
class Client
{
     ...
     *
     * @ORM\ManyToMany(targetEntity="Deal", inversedBy="client")
    ...
    {
        $this->dealRef = new \Doctrine\Common\Collections\ArrayCollection();
    }
     ...
     * @return Client
     */
    public function addDealRef(\Pi\PiAdminBundle\Entity\Deal $dealRef)
    {
     ...
     * @param \Pi\PiAdminBundle\Entity\Deal $dealRef
     */
    public function removeDealRef(\Pi\PiAdminBundle\Entity\Deal $dealRef)
    {
        $this->dealRef->removeElement($dealRef);
    }
